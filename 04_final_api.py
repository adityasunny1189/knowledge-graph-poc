...
# List of top scientists (this can be expanded as needed)
top_scientists = [
    "Andrew Yao", "Yoshua Bengio", "Geoffrey Hinton", "Yann LeCun", "Ian Goodfellow", 
    "Michael Jordan", "Judea Pearl", "Daphne Koller", "Stuart Russell", "Demis Hassabis"
    # Add more top scientists as needed, up to 500
]

def build_graph_for_scientists(scientists):
    for scientist in scientists:
        print(f"Processing {scientist}...")
        coauthors = fetch_coauthor_data(scientist)
        add_coauthors_to_neo4j(scientist, coauthors)

        time.sleep(1)  # Sleep to avoid rate limiting

if __name__ == "__main__":
    build_graph_for_scientists(top_scientists)
